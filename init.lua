...
vim.keymap.set('n', '<space>tx', ':Telescope file_browser path=%:p:h select_buffer=true<CR>')
vim.keymap.set('n', '<space>xc', ':NvimTreeToggle<CR>')
vim.keymap.set('n', '<space>xf', ':NvimTreeFocus<CR>')
